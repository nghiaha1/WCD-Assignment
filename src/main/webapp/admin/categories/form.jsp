...
<%@ page import="com.wcdexercise.wcdexercise4.entity.Category" %>
<%@ page import="com.wcdexercise.wcdexercise4.entity.myenum.CategoryStatus" %>
                                ...
                                <form action="<%= url %>" method="post" name="product-form">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <textarea id="summernote" name="detail"><%= obj.getName() %></textarea>
